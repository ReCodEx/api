...
class Version20171109163345 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'CREATE TABLE assignment_solution_submission (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', assignment_solution_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', evaluation_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', submitted_by_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', submitted_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime)\', results_url VARCHAR(255) DEFAULT NULL, job_config_path VARCHAR(255) NOT NULL, INDEX IDX_114838A3A598DA2 (assignment_solution_id), UNIQUE INDEX UNIQ_114838A3456C5646 (evaluation_id), INDEX IDX_114838A379F7D87D (submitted_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB'
        );
        $this->addSql(
            'ALTER TABLE assignment_solution_submission ADD CONSTRAINT FK_114838A3A598DA2 FOREIGN KEY (assignment_solution_id) REFERENCES assignment_solution (id)'
        );
        $this->addSql(
            'ALTER TABLE assignment_solution_submission ADD CONSTRAINT FK_114838A3456C5646 FOREIGN KEY (evaluation_id) REFERENCES solution_evaluation (id)'
        );
        $this->addSql(
            'ALTER TABLE assignment_solution_submission ADD CONSTRAINT FK_114838A379F7D87D FOREIGN KEY (submitted_by_id) REFERENCES user (id)'
        );
        $this->addSql(
            'ALTER TABLE submission_failure ADD assignment_solution_submission_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\''
        );
        $this->addSql(
    ...
    public function postUp(Schema $schema): void
    {
        ...
        foreach ($result as $row) {
            ...
            $this->connection->executeQuery(
                "INSERT INTO assignment_solution_submission " .
        ...
        $result = $this->connection->executeQuery(
            'SELECT * FROM submission_failure WHERE assignment_solution_id IS NOT NULL'
        );
        foreach ($result as $row) {
