...
class Version20171109102227 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'ALTER TABLE submission_failure CHANGE submission_id assignment_solution_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', CHANGE reference_solution_evaluation_id reference_solution_submission_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\''
        );
        $this->addSql(
            'ALTER TABLE submission_failure ADD CONSTRAINT FK_D7A9817A598DA2 FOREIGN KEY (assignment_solution_id) REFERENCES assignment_solution (id)'
        );
        $this->addSql(
