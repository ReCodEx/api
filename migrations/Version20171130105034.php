...
class Version20171130105034 extends AbstractMigration
{
  ...
  public function postUp(Schema $schema) {
    ...
    $files = $this->connection->executeQuery("SELECT * FROM uploaded_file WHERE discriminator = 'additionalexercisefile'");
    foreach ($files as $file) {
      $this->connection->executeQuery("UPDATE uploaded_file SET discriminator = 'attachmentfile' WHERE id = :id",
        ["id" => $file["id"]]);
    }
