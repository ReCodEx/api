...
class Version20180113115130 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'ALTER TABLE exercise_config ADD CONSTRAINT FK_A1C5BA173EA4CB4D FOREIGN KEY (created_from_id) REFERENCES exercise_config (id) ON DELETE SET NULL'
        );
        $this->addSql('ALTER TABLE exercise_environment_config DROP FOREIGN KEY FK_89540FF73EA4CB4D');
        $this->addSql(
            'ALTER TABLE exercise_environment_config ADD CONSTRAINT FK_89540FF73EA4CB4D FOREIGN KEY (created_from_id) REFERENCES exercise_environment_config (id) ON DELETE SET NULL'
        );
        $this->addSql('ALTER TABLE exercise_limits DROP FOREIGN KEY FK_238CADD03EA4CB4D');
        $this->addSql(
            'ALTER TABLE exercise_limits ADD CONSTRAINT FK_238CADD03EA4CB4D FOREIGN KEY (created_from_id) REFERENCES exercise_limits (id) ON DELETE SET NULL'
        );
    }
