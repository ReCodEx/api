...
class Version20171021162329 extends AbstractMigration
{
  ...
  public function up(Schema $schema): void
  {
    ...
    $this->addSql('CREATE TABLE group_user (group_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', user_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_A4C98D39FE54D947 (group_id), INDEX IDX_A4C98D39A76ED395 (user_id), PRIMARY KEY(group_id, user_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
  ...
  public function postUp(Schema $schema): void
  {
    ...
    $this->connection->executeQuery("INSERT INTO group_user (group_id, user_id) VALUES " . implode(', ', $this->groupAdmin));
  }
  ...
  public function down(Schema $schema): void
  {
    ...
    $this->addSql('ALTER TABLE `group` ADD admin_id CHAR(36) DEFAULT NULL COLLATE utf8_unicode_ci COMMENT \'(DC2Type:guid)\'');
