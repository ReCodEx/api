...
class Version20180301094432 extends AbstractMigration
{
  ...
  public function postUp(Schema $schema): void {
    ...
    $this->connection->executeQuery('ALTER TABLE submission_failure ADD CONSTRAINT FK_D7A9817B54DD80A FOREIGN KEY (reference_solution_submission_id) REFERENCES reference_solution_submission (id) ON DELETE CASCADE');
    ...
    $this->connection->executeQuery('ALTER TABLE submission_failure DROP FOREIGN KEY FK_D7A9817B54DD80A');
    $this->connection->executeQuery('ALTER TABLE submission_failure ADD CONSTRAINT FK_D7A9817B54DD80A FOREIGN KEY (reference_solution_submission_id) REFERENCES reference_solution_submission (id)');
  }
