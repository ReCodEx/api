...
class Version20171019205832 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE submission_failure CHANGE reference_solution_id reference_solution_evaluation_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\'');
        $this->addSql('ALTER TABLE submission_failure ADD CONSTRAINT FK_D7A981711DCC77F FOREIGN KEY (reference_solution_evaluation_id) REFERENCES reference_solution_evaluation (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE submission_failure CHANGE reference_solution_evaluation_id reference_solution_id CHAR(36) DEFAULT NULL COLLATE utf8_unicode_ci COMMENT \'(DC2Type:guid)\'');
