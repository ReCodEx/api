...
final class Version20190607231836 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'CREATE TABLE user_ui_data (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', data LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB'
        );
        $this->addSql('ALTER TABLE user ADD ui_data_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\'');
        $this->addSql(
            'ALTER TABLE user ADD CONSTRAINT FK_8D93D64925B58E7D FOREIGN KEY (ui_data_id) REFERENCES user_ui_data (id)'
        );
