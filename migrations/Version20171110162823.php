...
class Version20171110162823 extends AbstractMigration
{
  ...
  public function up(Schema $schema)
  {
    ...
    $this->addSql('ALTER TABLE assignment_solution DROP original_submission_id, DROP submitted_by_id, DROP evaluation_id, DROP submitted_at, DROP results_url, DROP job_config_path');
