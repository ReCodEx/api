...
final class Version20190504111926 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE assignment_solution ADD last_submission_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\'');
        $this->addSql('ALTER TABLE assignment_solution ADD CONSTRAINT FK_5B315D2E8DF22AA4 FOREIGN KEY (last_submission_id) REFERENCES assignment_solution_submission (id)');
        ...
        $this->addSql('UPDATE assignment_solution AS u LEFT JOIN (
