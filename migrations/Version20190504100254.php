...
final class Version20190504100254 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX assignment_solution_submission_submitted_at_idx ON assignment_solution_submission (submitted_at)');
        $this->addSql('CREATE INDEX ref_solution_submission_submitted_at_idx ON reference_solution_submission (submitted_at)');
