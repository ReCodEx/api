...
class Version20181207152232 extends AbstractMigration
{
  ...
  private const PYTHON_RUN_PIPELINES = ["Python execution & evaluation [stdout]", "Python execution & evaluation [outfile]"];
  ...
  private function removePythonCompilationPipeline(): ?string {
    ...
    $this->connection->executeQuery("DELETE FROM pipeline_parameter WHERE pipeline_id = :id",
      ["id" => $pipelineId]);
