...
class RouterFactory {
  ...
  private static function createExercisesRoutes(string $prefix): RouteList {
    ...
    $router[] = new GetRoute("$prefix/<id>/additional-files", "ExerciseFiles:getAdditionalFiles");
  ...
  private static function createGroupsRoutes(string $prefix): RouteList {
    ...
    $router[] = new GetRoute("$prefix/<id>/public", "Groups:publicDetail");
  ...
  private static function createInstancesRoutes(string $prefix): RouteList {
    ...
    $router[] = new GetRoute("$prefix/<id>/groups/public", "Instances:publicGroups");
  ...
  private static function createUsersRoutes(string $prefix): RouteList {
    ...
    $router[] = new GetRoute("$prefix/<id>/public", "Users:publicData");
