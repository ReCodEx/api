...
class AssignmentSolutionSubmissions extends BaseRepository {
   ...
   */
  public function getLastSubmission(AssignmentSolution $solution, ?AssignmentSolutionSubmission $omitThisSubmission = null)
  {
    ...
    if ($omitThisSubmission !== null) {
      ...
      $submissions = array_filter($submissions, function($submission) use ($omitSubmissionId) {
