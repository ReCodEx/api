...
class TestExerciseConfigValidator extends Tester\TestCase
{
    ...
    public function testMissingEnvironment()
    {
        ...
        Assert::exception(
            ...
            "Exercise configuration error - The number of entries in environment-specific configuration differs from the number of allowed environments"
        );
    }
    ...
    public function testDifferentEnvironments()
    {
        ...
        Assert::exception(
            ...
            ExerciseConfigException::class,
            "Exercise configuration error - Environment envA not found in environment-specific configuration"
        );
    }
    ...
    public function testMissingEnvironmentPipeline()
    {
        ...
        Assert::exception(
            ...
            ExerciseConfigException::class,
            "Exercise configuration error - Pipeline 'not existing pipeline' not found"
        );
    }
    ...
    public function testDifferentNumberOfTests()
    {
        ...
        Assert::exception(
            ...
            ExerciseConfigException::class,
            "Exercise configuration error - Number of tests in configuration do not correspond to the ones in exercise"
        );
    }
    ...
    public function testDifferentTestIds()
    {
        ...
        Assert::exception(
            ...
            ExerciseConfigException::class,
            "Exercise configuration error - Test with id '3' not found in exercise tests"
        );
    }
