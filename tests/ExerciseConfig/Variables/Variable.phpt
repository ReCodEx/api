...
class TestVariable extends Tester\TestCase
{
    ...
    {
        Assert::equal(
            VariableTypes::$STRING_TYPE,
            $this->loader->loadVariable(["name" => "varName", "type" => "string", "value" => "val"])->getType()
        );
        Assert::equal(
            VariableTypes::$STRING_TYPE,
            $this->loader->loadVariable(["name" => "varName", "type" => "StRiNg", "value" => "val"])->getType()
        ...
        Assert::equal(
            VariableTypes::$STRING_ARRAY_TYPE,
            $this->loader->loadVariable(
                ["name" => "varName", "type" => "string[]", "value" => ["val"]]
            )->getType()
        );
        Assert::equal(
            VariableTypes::$STRING_ARRAY_TYPE,
        ...
        Assert::equal(
            VariableTypes::$FILE_TYPE,
            $this->loader->loadVariable(["name" => "varName", "type" => "file", "value" => "val"])->getType()
        );
        Assert::equal(
            VariableTypes::$FILE_TYPE,
            $this->loader->loadVariable(["name" => "varName", "type" => "FiLe", "value" => "val"])->getType()
        ...
        Assert::equal(
            VariableTypes::$FILE_ARRAY_TYPE,
            $this->loader->loadVariable(
                ["name" => "varName", "type" => "file[]", "value" => ["val"]]
            )->getType()
        );
        Assert::equal(
            VariableTypes::$FILE_ARRAY_TYPE,
