...
class TestFilesInBox extends Tester\TestCase
{
    ...
    public function __construct()
    {
        ...
        $outputPort = (new Port(
            (new PortMeta())->setName(FilesInBox::$FILES_IN_PORT_KEY)->setType(VariableTypes::$FILE_ARRAY_TYPE)
        ));
    ...
    public function testRemoteAndLocalDifferentCount()
    {
        Assert::exception(
            ...
            "Exercise submission error - Different count of remote variables and local variables in box ''"
        );
    }
