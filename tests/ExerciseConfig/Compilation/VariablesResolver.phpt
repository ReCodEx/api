...
class TestVariablesResolver extends Tester\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $submitRefReferenceVarA = (new Variable("file"))->setName("test-a-submit-ref-reference-variable")->setValue(
            '$test-a-submit-reference-variable'
        );
        $submitReferenceVarA = (new Variable("file"))->setName("test-a-submit-reference-variable")->setValue(
            '$submitFileRef'
        );

        $this->envVarTableA = (new VariablesTable())->set($outputReferencedVarA)->set($testRemoteInputVarA)->set(
            $testInputArrayVarA
        )->set($submitReferenceVarA);
        $this->exerVarTableA = (new VariablesTable())->set($referencedVarA);
        $this->pipeVarTableA = (new VariablesTable())->set($testInputVarA)->set($testInputArrayVarA)->set(
            $testOutputVarA
        )->set($preExecVarA)->set($submitRefReferenceVarA);

        $outPortA = new Port(
            (new PortMeta())->setName("data-in")->setType(VariableTypes::$FILE_TYPE)->setVariable(
                $testInputVarA->getName()
            )
        );
        $dataInNodeA = new PortNode((new CustomBox())->setName("in")->addOutputPort($outPortA));

        $outPortArrayA = new Port(
            (new PortMeta())->setName("data-in-arr")->setType(VariableTypes::$FILE_TYPE)->setVariable(
                $testInputArrayVarA->getName()
            )
        );
        $dataInNodeArrayA = new PortNode((new CustomBox())->setName("in-arr")->addOutputPort($outPortArrayA));

        $preExecPortA = new Port(
            (new PortMeta())->setName("pre-data")->setType(VariableTypes::$FILE_TYPE)->setVariable(
                $preExecVarA->getName()
            )
        );
        ...
        $inRefPortA = new Port(
            (new PortMeta())->setName("in-ref")->setType(VariableTypes::$FILE_TYPE)->setVariable(
                $submitRefReferenceVarA->getName()
            )
        );
        $inPortA = new Port(
            (new PortMeta())->setName("data-out")->setType(VariableTypes::$FILE_TYPE)->setVariable(
                $testOutputVarA->getName()
            )
        );
        $execNodeA = new PortNode(
            (new CustomBox())->setName("exec")
                ->addInputPort($preExecPortA)->addInputPort($outPortA)->addInputPort($outPortArrayA)->addInputPort(
                    $inRefPortA
                )->addOutputPort($inPortA)
        );
        ...
        $testRemoteInputVarBC = (new Variable("remote-file"))->setName("test-bc-remote-input")->setValue(
            "input.BC.name"
        );
        ...
        $outPortBA = new Port(
            (new PortMeta())->setName("data-in-a")->setType(VariableTypes::$FILE_TYPE)->setVariable(
                $testInputVarBA->getName()
            )
        );
        $dataInNodeBA = new PortNode((new CustomBox())->setName("inBA")->addOutputPort($outPortBA));

        $outPortBB = new Port(
            (new PortMeta())->setName("data-in-b")->setType(VariableTypes::$FILE_TYPE)->setVariable(
                $testInputVarBB->getName()
            )
        );
        $dataInNodeBB = new PortNode((new CustomBox())->setName("inBB")->addOutputPort($outPortBB));

        $inPortBC = new Port(
            (new PortMeta())->setName("data-in-remote-c")->setType(VariableTypes::$REMOTE_FILE_TYPE)->setVariable(
                $testRemoteInputVarBC->getName()
            )
        );
        $outPortBC = new Port(
            (new PortMeta())->setName("data-in-c")->setType(VariableTypes::$FILE_TYPE)->setVariable(
                $testInputVarBC->getName()
            )
        );
        $dataInNodeBC = new PortNode(
            (new CustomBox())->setName("inBC")->addInputPort($inPortBC)->addOutputPort($outPortBC)
        );

        $onlyInPortB = new Port(
            (new PortMeta())->setName("data-only-in")->setType(VariableTypes::$STRING_TYPE)->setVariable(
                $testOnlyInputVarB->getName()
            )
        );
        $inPortBA = new Port(
            (new PortMeta())->setName("data-out-a")->setType(VariableTypes::$FILE_TYPE)->setVariable(
                $testOutputVarBA->getName()
            )
        );
        $inPortBB = new Port(
            (new PortMeta())->setName("data-out-b")->setType(VariableTypes::$FILE_TYPE)->setVariable(
                $testOutputVarBB->getName()
            )
        );
        $execNodeB = new PortNode(
            (new CustomBox())->setName("execB")
    ...
    public function testMissingVariableInInputBoxTables()
    {
        Assert::exception(
            ...
            "Exercise submission error - Variable 'test-bb-input' from input data box could not be resolved"
        );
    }
    ...
    public function testMissingReferencedVariable()
    {
        Assert::exception(
            ...
            ExerciseCompilationException::class,
            "Exercise submission error - Variable reference 'test-a-reference-variable' could not be resolved"
        );
    }
    ...
    public function testVariableNamesNotMatchesInInputBox()
    {
        Assert::exception(
            ...
            ExerciseCompilationException::class,
            "Exercise submission error - Variable 'something which does not exist' from input data box could not be resolved"
        );
    }
    ...
    public function testVariableNamesNotMatchesInOtherBox()
    {
        Assert::exception(
            ...
            ExerciseCompilationException::class,
            "Exercise submission error - Malformed tree - variables in corresponding ports (data-out, data-out) do not matches"
        );
    }
    ...
    public function testMissingVariableInPipelinesTable()
    {
        Assert::exception(
            ...
            ExerciseCompilationException::class,
            "Exercise submission error - Variable 'test-a-pre-exec' could not be resolved"
        );
    }
    ...
    public function testBadConnectionBetweenInputNodesParentNotFound()
    {
        Assert::exception(
            ...
            ExerciseCompilationException::class,
            "Exercise submission error - Malformed tree - input node 'in' not found in child 'exec'"
        );
    }
    ...
    public function testBadConnectionBetweenNodesParentNotFound()
    {
        Assert::exception(
            ...
            ExerciseCompilationException::class,
            "Exercise submission error - Malformed tree - node 'exec' not found in child 'out'"
        );
    }
    ...
    public function testBadConnectionBetweenNodesChildNotFound()
    {
        Assert::exception(
            ...
            ExerciseCompilationException::class,
            "Exercise submission error - Malformed tree - node 'exec' not found in parent 'pre-exec'"
        );
    }
    ...
    public function testUnknownHashOfFile()
    {
        Assert::exception(
            ...
            ExerciseCompilationException::class,
            "Exercise submission error - File 'input.A.name' does not exist in exercise or pipeline."
        );
    }
    ...
    public function testNotMatchingRegexp()
    {
        Assert::throws(
            ...
            ExerciseCompilationException::class,
            "Exercise submission error - None of the submitted files matched regular expression 'out*' in variable 'test-a-input'"
        );
    }

    public function testNotDefinedSubmitReference()
    {
        Assert::throws(
            function () {
                $context = CompilationContext::create(
                ...
                $params = CompilationParams::create(["infile"]);
                $this->resolver->resolve(
                    $this->treeArray[0],
                    $this->exerVarTableA,
                    $this->pipeVarTableA,
            ...
            ExerciseCompilationException::class,
            "Exercise submission error - Variable 'submitFileRef' was not provided on submit"
        );
    }
    ...
    public function testNotSubmittedFileFromSubmitReference()
    {
        Assert::throws(
            ...
            ExerciseCompilationException::class,
            "Exercise submission error - File 'wrong.file.in' in variable 'submitFileRef' could not be found among submitted files"
        );
    }
    ...
    public function testCorrect()
    {
        ...
        $files = ["infile"];
        $params = CompilationParams::create($files, false, new SolutionParams(self::$solutionParams));
        $contextA = CompilationContext::create(
            new ExerciseConfig(),
            $this->envVarTableA,
            [],
            self::$exerciseFiles,
        ...
        $contextB = CompilationContext::create(
            new ExerciseConfig(),
            $this->envVarTableB,
            [],
            self::$exerciseFiles,
        ...
        Assert::equal(
            "test-a-input",
            $treeA->getInputNodes()[0]->getBox()->getOutputPorts()["data-in"]->getVariableValue()->getName()
        );
        Assert::equal(
            "test-a-input",
            $treeA->getOtherNodes()[0]->getBox()->getInputPorts()["data-in"]->getVariableValue()->getName()
        );

        Assert::equal(
            "test-a-reference-variable",
            $treeA->getOtherNodes()[0]->getBox()->getInputPorts()["pre-data"]->getVariableValue()->getName()
        );
        Assert::equal(
            "test-a-reference-variable",
            $treeA->getOtherNodes()[1]->getBox()->getOutputPorts()["pre-data"]->getVariableValue()->getName()
        );

        Assert::equal(
            "test-a-output-reference",
            $treeA->getOtherNodes()[0]->getBox()->getOutputPorts()["data-out"]->getVariableValue()->getName()
        );
        Assert::equal(
            "test-a-output-reference",
            $treeA->getOutputNodes()[0]->getBox()->getInputPorts()["data-out"]->getVariableValue()->getName()
        );

        Assert::equal(
            "test-a-submit-reference-variable",
            $treeA->getOtherNodes()[0]->getBox()->getInputPorts()["in-ref"]->getVariableValue()->getName()
        );
        Assert::equal(
            "infile",
            $treeA->getOtherNodes()[0]->getBox()->getInputPorts()["in-ref"]->getVariableValue()->getValue()
        );
        ...
        Assert::equal(
            "test-ba-input",
            $treeB->getInputNodes()[0]->getBox()->getOutputPorts()["data-in-a"]->getVariableValue()->getName()
        );
        Assert::equal(
            "test-ba-input",
            $treeB->getOtherNodes()[0]->getBox()->getInputPorts()["data-in-a"]->getVariableValue()->getName()
        );

        Assert::equal(
            "test-bb-input",
            $treeB->getInputNodes()[1]->getBox()->getOutputPorts()["data-in-b"]->getVariableValue()->getName()
        );
        Assert::equal(
            "test-b-only-input",
            $treeB->getOtherNodes()[0]->getBox()->getInputPorts()["data-only-in"]->getVariableValue()->getName()
        );
        Assert::equal(
            "test-bb-input",
            $treeB->getOtherNodes()[0]->getBox()->getInputPorts()["data-in-b"]->getVariableValue()->getName()
        );

        Assert::equal(
            "test-ba-output",
            $treeB->getOtherNodes()[0]->getBox()->getOutputPorts()["data-out-a"]->getVariableValue()->getName()
        );
        Assert::equal(
            "test-ba-output",
            $treeB->getOutputNodes()[0]->getBox()->getInputPorts()["data-out-a"]->getVariableValue()->getName()
        );

        Assert::equal(
            "test-bb-output",
            $treeB->getOtherNodes()[0]->getBox()->getOutputPorts()["data-out-b"]->getVariableValue()->getName()
        );
        Assert::equal(
            "test-bb-output",
            $treeB->getOutputNodes()[1]->getBox()->getInputPorts()["data-out-b"]->getVariableValue()->getName()
        );

        Assert::equal(
            "test-bc-remote-input",
            $treeB->getOtherNodes()[1]->getBox()->getInputPort("data-in-remote-c")->getVariableValue()->getName()
        );
        Assert::equal(
            "input.BC.hash",
            $treeB->getOtherNodes()[1]->getBox()->getInputPort("data-in-remote-c")->getVariableValue()->getValue()
        );
        Assert::equal(
            "input.BC",
            $treeB->getOtherNodes()[1]->getBox()->getOutputPort("data-in-c")->getVariableValue()->getValue()
        );
    }
