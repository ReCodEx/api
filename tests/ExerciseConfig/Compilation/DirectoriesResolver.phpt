...
class TestDirectoriesResolver extends Tester\TestCase
{
  ...
  public function testCorrect() {
    ...
    $C = (new Node())->setBox((new CustomBox("C"))->addInputPort($portC1)->addOutputPort($portC2)->addOutputPort($portC3));
    $C->setTestId("1");
    ...
    $F = (new Node())->setBox((new CustomBox("F"))->addInputPort($portF1)->addInputPort($portF2)->addOutputPort($portF3));
    $F->setTestId("2");
    ...
    Assert::true(Strings::startsWith(current($mkdirCustomA->getBox()->getInputPorts())->getVariableValue()->getValue(), "custom_"));
    ...
    Assert::true(Strings::startsWith(current($mkdirCustomB->getBox()->getInputPorts())->getVariableValue()->getValue(), "custom_"));
    ...
    Assert::equal($Adir . "/valAB", $A->getBox()->getOutputPort("portAB")->getVariableValue()->getDirPrefixedValue());
    Assert::equal($Adir . "/valAF", $A->getBox()->getOutputPort("portAF")->getVariableValue()->getDirPrefixedValue());
    ...
    Assert::equal($Adir . "/valAF", current($AFcopy->getBox()->getInputPorts())->getVariableValue()->getDirPrefixedValue());
    Assert::count(1, $AFcopy->getBox()->getOutputPorts());
    Assert::equal("testB/valAF", current($AFcopy->getBox()->getOutputPorts())->getVariableValue()->getDirPrefixedValue());
    ...
    Assert::equal($Adir . "/valAB", current($ABcopy->getBox()->getInputPorts())->getVariableValue()->getDirPrefixedValue());
    Assert::count(1, $ABcopy->getBox()->getOutputPorts());
    Assert::equal("testA/valAB", current($ABcopy->getBox()->getOutputPorts())->getVariableValue()->getDirPrefixedValue());
    ...
    Assert::equal("testA/valBC", current($B->getBox()->getOutputPorts())->getVariableValue()->getDirPrefixedValue());
    ...
    Assert::equal(["testA/valCE1", "testA/valCE2"], $C->getBox()->getOutputPort("portCE")->getVariableValue()->getDirPrefixedValue());
    ...
    Assert::equal(["testA/valCE1", "testA/valCE2"], current($CEcopy->getBox()->getInputPorts())->getVariableValue()->getDirPrefixedValue());
    Assert::count(1, $CEcopy->getBox()->getOutputPorts());
    Assert::equal([$mkdirCustomB->getBox()->getDirectory() . "/valCE1", $mkdirCustomB->getBox()->getDirectory() . "/valCE2"],
    ...
    Assert::equal([$Edir . "/valCE1", $Edir . "/valCE2"], current($E->getBox()->getInputPorts())->getVariableValue()->getDirPrefixedValue());
    Assert::count(1, $E->getBox()->getOutputPorts());
    Assert::equal($Edir . "/valEH", current($E->getBox()->getOutputPorts())->getVariableValue()->getDirPrefixedValue());
    ...
    Assert::equal($Hdir . "/valEH", current($H->getBox()->getInputPorts())->getVariableValue()->getDirPrefixedValue());
    ...
    Assert::equal("testB/valAF", $F->getBox()->getInputPorts()["portAF"]->getVariableValue()->getDirPrefixedValue());
    Assert::equal("valF2", $F->getBox()->getInputPorts()["portF2"]->getVariableValue()->getValue());
    Assert::count(1, $F->getBox()->getOutputPorts());
    Assert::equal("testB/valFG", $F->getBox()->getOutputPorts()["portFG"]->getVariableValue()->getDirPrefixedValue());
    ...
    Assert::equal("testB/valFG", $G->getBox()->getInputPorts()["portFG"]->getVariableValue()->getDirPrefixedValue());
