...
class TestNotificationsPresenter extends Tester\TestCase
{
  ...
  public function testCreate() {
    ...
    $request = new Nette\Application\Request("V1:Notifications", "POST",
      ["action" => "create"],
      [
        "groupsIds" => $groupsIds,
  ...
  public function testRemove() {
    ...
    $request = new Nette\Application\Request("V1:Notifications", "DELETE",
    ...
    Assert::exception(function () use ($notificationId) {
