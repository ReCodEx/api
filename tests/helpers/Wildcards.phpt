...
Assert::same(["hello, world", "hello, dude", "hi, world", "hi, dude"], iterator_to_array(Wildcards::expandPattern("{hello,hi}, {world,dude}")));
Assert::same(["hello, world", "hi, world", "hey, world"], iterator_to_array(Wildcards::expandPattern("{hello,{hi,hey}}, world")));
